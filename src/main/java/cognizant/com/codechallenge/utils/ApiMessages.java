...
public class ApiMessages {
    ...
    public static final String RECORD_NOT_FOUND="Record currently unavailable, no success task recorded yet.";
    public static final String ERROR="Internal error! kindly contact support";
